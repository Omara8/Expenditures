package com.planatech.expenditures.utils.progressiveLayouts;
...
public class ProgressConstraintLayout extends ConstraintLayout implements ProgressLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        loadingStateProgressBarColor =
                typedArray.getColor(R.styleable.ProgressActivity_loadingProgressBarColor, getResources().getColor(R.color.colorAccent));
    ...
    public void showContent() {
        switchState(CONTENT, 0, null, null, null, null, Collections.emptyList());
    }
    ...
    public void showLoading() {
        switchState(LOADING, 0, null, null, null, null, Collections.emptyList());
    }
    ...
    public void showEmpty(int icon, String title, String description) {
        switchState(EMPTY, icon, title, description, null, null, Collections.emptyList());
    }
    ...
    public void showError(int icon, String title, String description, String buttonText, OnClickListener buttonClickListener) {
        switchState(ERROR, icon, title, description, buttonText, buttonClickListener, Collections.emptyList());
    }
    ...
    private void switchState(String state, int icon, String title, String description,
        ...
        switch (state) {
            ...
            case ERROR:
                ...
                if (buttonText == null) {
                    errorStateButton.setVisibility(View.INVISIBLE);
                } else {
